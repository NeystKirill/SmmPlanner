...
namespace App\View;
/**
 * Класс Main расширяет Base и представляет собой шаблон, который используется на всех основных страницах приложения.
 */
class Main extends \App\View\Base
{
    /**
     * Основная функция для отрисовки контента на странице.
     * Использует данные, переданные в параметре $i_am_batman для динамического отображения содержимого.
     *
     * @param array $i_am_batman Массив данных, который используется для отображения специфической информации на странице.
     */
    public function container(array $i_am_batman)
    {
                    ...
                    <li>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li>
                                    <a tabindex="-1" href="/profile/password">
     ...
     /**
     * Метод для отображения таблицы данных на странице.
                    ...
                    <tr>
                            ...
                            <?php if ($column == 'action_of_row'): ?>
                                ...
                                <?php foreach ($options['buttons'] as $button) : ?>
                                    <a href="<?= $button['href']?>?id=<?=$user['id']?>&creator=<?= $user['creator'] ?? ''?>" class = "<?= $button['button_class']?>"><i class = "<?= $button['i_class']?>"><?=$button['label']?></i></a>  
                                <?php endforeach; ?>
                                </td>   
                            <?php else :?>
